...
export const Topography: FC<TopographyProps> = ({
  lowColor = "var(--primary)",
  midColor = "var(--chart-2)",
  highColor = "var(--foreground)",
  speed = 0.35,
  morphAmount = 3.0,
  morphSpeed = 0.05,
  bands = 2.0,
  ...
  useEffect(() => {
    ...
    u.uLow.value = new Float32Array(hexToRgb(resolveColor(lowColor, container)))
    u.uMid.value = new Float32Array(hexToRgb(resolveColor(midColor, container)))
    u.uHigh.value = new Float32Array(hexToRgb(resolveColor(highColor, container)))
