  ...
  ({
    ...
    useEffect(() => {
      ...
      function tick() {
        ...
        grad.addColorStop(0, resolveColor(p.gradientFrom as string, root))
        grad.addColorStop(1, resolveColor(p.gradientTo as string, root))
        ctx!.fillStyle = grad
    ...
    return (
      <div ref={rootRef} className={cn("relative h-full w-full", className)} {...rest}>
        <canvas
          ref={canvasRef}
          style={{
            position: "absolute",
        ...
        >
          <defs>
            <radialGradient id={glowIdRef.current}>
              <stop offset="0%" stopColor={resolveColor(glowColor, rootRef.current)} />
