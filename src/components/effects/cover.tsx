...
function Beam({ className, delay, duration, hovered, width = 600, ...svgProps }: { className?: string; delay?: number; duration?: number; hovered?: boolean; width?: number } & React.ComponentProps<typeof motion.svg>) {
  const id = useId()
...
function CircleIcon({ className, delay }: { className?: string; delay?: number }) {
  return (
    <div
