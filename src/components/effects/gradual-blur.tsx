...
const useResponsiveDimension = (
  ...
  useEffect(() => {
    ...
    const calc = () => {
      ...
      if (w <= 480 && anyConfig["mobile" + k]) v = anyConfig["mobile" + k] as string
      else if (w <= 768 && anyConfig["tablet" + k]) v = anyConfig["tablet" + k] as string
      else if (w <= 1024 && anyConfig["desktop" + k]) v = anyConfig["desktop" + k] as string
      setVal(v)
    }
...
export const GradualBlur = React.memo(GradualBlurImpl)
