...
function LoaderCore({ loadingStates, value = 0 }: { loadingStates: LoadingState[]; value?: number }) {
  return (
...
function MultiStepLoader({ loadingStates, loading, duration = 2000, loop = true }: { loadingStates: LoadingState[]; loading?: boolean; duration?: number; loop?: boolean }) {
