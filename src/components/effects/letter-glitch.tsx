...
export function LetterGlitch({
  glitchColors = ["var(--chart-2)", "var(--chart-1)", "var(--chart-3)"],
  glitchSpeed = 50,
  ...
  const getRandomColor = () => {
    return resolveColor(glitchColors[Math.floor(Math.random() * glitchColors.length)], rootRef.current)
  }
  ...
  return (
    <div
      ...
      style={{
        backgroundColor:
          backgroundColor ??
          colorToRgba(resolveColor(lightMode ? "var(--background)" : "var(--background)"), 1)
      }}
    >
