...
export const Grainient: FC<GrainientProps> = ({
  ...
  useEffect(() => {
    ...
    u.uZoom.value = zoom
    u.uColor1.value = new Float32Array(hexToRgb(resolveColor(color1, container)))
    u.uColor2.value = new Float32Array(hexToRgb(resolveColor(color2, container)))
    u.uColor3.value = new Float32Array(hexToRgb(resolveColor(color3, container)))
