...
export const Waves: FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    function drawLines() {
      ...
      ctx.beginPath()
      ctx.strokeStyle = colorToRgba(resolveColor(configRef.current.lineColor, container), 0.85)
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 h-[0.5rem] w-[0.5rem] rounded-full bg-foreground"
        style={{
