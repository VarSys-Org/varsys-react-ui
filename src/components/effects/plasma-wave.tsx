...
export function PlasmaWave({
  ...
  const propsRef = useRef<PlasmaWaveProps>({ xOffset, yOffset, rotationDeg, focalLength, speed1, speed2, dir2, bend1, bend2, colors, lightMode })
  propsRef.current = { xOffset, yOffset, rotationDeg, focalLength, speed1, speed2, dir2, bend1, bend2, colors, lightMode }
  ...
  useEffect(() => {
    ...
    const c1 = hexToRgb(resolveColor(colors[0], ctn))
    const c2 = hexToRgb(resolveColor(colors[1], ctn))
    ...
    const update = (now: number) => {
      const {
        ...
        bend1: b1 = 1,
        bend2: b2 = 0.5,
        colors: cols = ["var(--primary)", "var(--chart-2)"],
      ...
      program.uniforms.uColor1.value = hexToRgb(resolveColor(cols[0], ctn))
      program.uniforms.uColor2.value = hexToRgb(resolveColor(cols[1], ctn))
