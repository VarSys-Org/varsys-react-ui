...
export function ScrollStackItem({ children, itemClassName = "" }: ScrollStackItemProps) {
  return (
    <div
      className={cn(
        "scroll-stack-card relative my-8 box-border h-80 w-full origin-top rounded-[40px] p-12 shadow-[0_0_30px_rgba(0,0,0,0.1)] will-change-transform",
        itemClassName
      )}
      style={{
...
export function ScrollStack({
  ...
  return (
    <div
      className={cn("relative h-full w-full overflow-x-visible overflow-y-auto", className)}
      ref={scrollerRef}
      style={{
