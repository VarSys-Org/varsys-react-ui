...
export interface ScriptCopyBtnProps extends HTMLAttributes<HTMLDivElement> {
  /** Show the package manager selector tabs */
  showMultiplePackageOptions?: boolean
  /** The language of the code to highlight (e.g. "shell", "bash") */
  codeLanguage: string
  /** Shiki theme used in light mode */
  lightTheme: string
  /** Shiki theme used in dark mode */
  darkTheme: string
  /** Map of package manager name to install command */
