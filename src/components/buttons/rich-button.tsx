...
export type RichButtonSize = "sm" | "default" | "lg"
...
const colorMap: Record<RichButtonColor, string> = {
  default:
...
const textShadowMap: Record<RichButtonColor, string> = {
  default:
...
const sizeMap: Record<RichButtonSize, string> = {
  ...
  (
    ...
    return (
      <Comp
        ref={ref}
        className={cn(
          "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-medium ring-0 transition-[filter] duration-200 hover:brightness-110 active:brightness-95 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border border-zinc-950/35 bg-gradient-to-b shadow-md shadow-zinc-950/20 dark:border-0 dark:border-zinc-950/50 dark:bg-gradient-to-t shadow-[inset_0_0_0_1px_rgba(255,255,255,0.25)]",
          colorClasses,
          sizeClasses,
          textColor,
          className,
