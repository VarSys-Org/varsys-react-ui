...
export type PopButtonSize = "sm" | "default" | "lg"
...
const baseClasses =
  "inline-flex select-none origin-bottom items-center justify-center whitespace-nowrap rounded-xl border-x-2 border-t-2 border-b-4 ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:scale-y-95 active:border-b-2 disabled:pointer-events-none disabled:opacity-50 text-primary-foreground"
