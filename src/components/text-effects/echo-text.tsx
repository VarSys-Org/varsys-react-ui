...
export function EchoText({
  ...
  return (
    <span
      ref={rootRef}
      className={`relative inline-block select-none whitespace-nowrap leading-[0.9] tracking-[-0.04em] [contain:layout_style] [font-kerning:normal] [text-rendering:geometricPrecision] ${className}`.trim()}
      style={rootStyle}
    >
      {copyIndexes
        .slice(1)
