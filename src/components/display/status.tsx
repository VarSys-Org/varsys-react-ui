  ...
  "inline-flex w-fit shrink-0 items-center gap-1.5 overflow-hidden rounded-full border px-2.5 py-1 text-xs font-medium whitespace-nowrap transition-colors",
  {
    variants: {
      variant: {
        ...
        success:
          "border-green-500/20 bg-green-500/10 text-green-600 dark:text-green-400 [&_[data-slot=status-indicator]]:bg-green-600 dark:[&_[data-slot=status-indicator]]:bg-green-400",
        error:
          "border-destructive/20 bg-destructive/10 text-destructive [&_[data-slot=status-indicator]]:bg-destructive",
        warning:
          "border-orange-500/20 bg-orange-500/10 text-orange-600 dark:text-orange-400 [&_[data-slot=status-indicator]]:bg-orange-600 dark:[&_[data-slot=status-indicator]]:bg-orange-400",
        info: "border-blue-500/20 bg-blue-500/10 text-blue-600 dark:text-blue-400 [&_[data-slot=status-indicator]]:bg-blue-600 dark:[&_[data-slot=status-indicator]]:bg-blue-400",
      },
    },
    defaultVariants: {
      variant: "default",
