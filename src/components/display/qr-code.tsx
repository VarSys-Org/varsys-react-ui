...
export interface QRCodeProps extends React.SVGProps<SVGSVGElement> {
  /** Value (text or URL) to encode into the QR code. */
  value: string
  /** Rendered size in pixels. */
  size?: number
  /** Color of the dark modules. Accepts any CSS color, including CSS variables. */
  fgColor?: string
  /** Background color behind the modules. Accepts any CSS color, including CSS variables. */
  bgColor?: string
  /** Error correction level. Higher levels survive more damage. */
