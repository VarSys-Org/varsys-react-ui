...
export function LoginForm({
  ...
  return (
    <div
      className={cn(
        "w-full flex flex-col items-center justify-center px-4 py-10",
        variant === "providers" && "bg-gray-50 sm:px-4",
        className
      )}
    >
      <div
        className={cn(
          "w-full space-y-6 text-gray-600",
          variant === "basic" ? "max-w-sm" : "sm:max-w-md"
        )}
      >
        ...
        <div
          className={cn(
            variant === "providers" &&
              "bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg"
          )}
        >
          {variant === "providers" ? (
            <>
