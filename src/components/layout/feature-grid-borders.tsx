...
export interface FeatureGridBordersItem {
  title: string
  description: string
  icon: React.ReactNode
}

export interface FeatureGridBordersProps
  extends React.HTMLAttributes<HTMLDivElement> {
  features: FeatureGridBordersItem[]
}

export function FeatureGridBorders({
  features,
  className,
}: FeatureGridBordersProps) {
  return (
    <div
      className={cn(
...
const FeatureItem = ({
  ...
  icon,
  index,
}: FeatureGridBordersItem & { index: number }) => {
  return (
    <div
      className={cn(
...
export default FeatureGridBorders
