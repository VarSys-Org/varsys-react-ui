...
export interface ArcTimelineProps extends ComponentPropsWithoutRef<"div"> {
  className?: string
...
export function ArcTimeline({
  ...
  const {
    time: defaultActiveTime = data[0].time as string,
                  ...
                  <div key={`${lineIndex}-${stepIndex}`}>
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          className={cn(
                            "absolute bottom-0 left-1/2 flex w-[240px] -translate-x-1/2 translate-y-[calc(100%_+_42px)] items-center justify-center text-center text-sm transition-opacity duration-300 ease-in line-clamp-3",
