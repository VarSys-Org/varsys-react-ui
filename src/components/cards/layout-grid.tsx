...
function LayoutGrid({ cards }: { cards: Card[] }) {
  ...
  return (
    <div data-slot="layout-grid" className="w-full h-full p-10 grid grid-cols-1 md:grid-cols-3 max-w-7xl mx-auto gap-4 relative">
      {cards.map((card, i) => (
...
export { LayoutGrid }
export type { Card as LayoutGridCard }
