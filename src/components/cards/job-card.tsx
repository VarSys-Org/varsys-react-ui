...
export function JobCard({
  ...
  description = "We're currently looking talent software engineers, and designers to help us in our missions and to grow up.",
  className,
}: JobCardProps) {
  return (
      ...
      <div className="max-w-screen-lg mx-auto px-4 md:px-8">
        ...
        <ul className="mt-12 divide-y space-y-3">
          {jobs.map((item, idx) => (
            ...
            >
              <a href={item.href ?? "#"} className="space-y-3">
                ...
                <p className="text-gray-600 sm:text-sm">{item.jobDescription}</p>
