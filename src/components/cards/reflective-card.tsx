    ...
    >
      ...
      {webcam && streamActive ? (
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 30% 25%, rgba(255,255,255,0.25) 0%, rgba(255,255,255,0.05) 30%, rgba(0,0,0,0.6) 100%), linear-gradient(135deg, #2a2a35 0%, #101016 100%)'
          }}
        />
      )}
      ...
      <div className="relative z-10 h-full flex flex-col justify-between p-8 text-[var(--text-color,white)] bg-[var(--overlay-color,rgba(255,255,255,0.05))]">
        ...
        <div className="flex-1 flex flex-col justify-end items-center text-center gap-6 mb-8">
          <div className="text-center">
            ...
            <p className="text-xs tracking-[0.2em] opacity-70 m-0 uppercase">{role}</p>
          </div>
        </div>
