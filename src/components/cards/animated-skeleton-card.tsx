...
function Skeleton() {
  ...
  React.useEffect(() => {
    animate(sequence as unknown as Parameters<typeof animate>[0], {
      repeat: Infinity,
      repeatDelay: 1,
    })
  }, [sequence])
  ...
  return (
    <div className="relative flex h-full items-center justify-center overflow-hidden p-8">
      ...
      <div className="absolute top-20 z-40 m-auto h-40 w-px bg-gradient-to-b from-transparent via-cyan-500 to-transparent animate-move">
...
export function AnimatedSkeletonCard({
  ...
  return (
    <div
      className={cn(
        "group mx-auto w-full max-w-sm rounded-xl border border-border bg-gray-100 p-8 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] dark:bg-[rgba(40,40,40,0.70)]",
        className
      )}
      {...props}
    >
      ...
      <h3 className="py-2 text-lg font-semibold text-gray-800 dark:text-white">
        {title}
      </h3>
      <p className="max-w-sm text-sm font-normal text-neutral-600 dark:text-neutral-400">
        {description}
      </p>
    </div>
  )
