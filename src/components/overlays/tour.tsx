...
function TourClose(props: TourCloseProps) {
  ...
  return (
    <ClosePrimitive
      ...
      className={cn(
        "absolute top-4 right-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      onClick={onClick}
      {...closeButtonProps}
...
TourSpotlightRing.displayName = "TourSpotlightRing"
