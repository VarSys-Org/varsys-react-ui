...
function ActionBarItem(props: ActionBarItemProps) {
  ...
  const propsRef = useAsRef({
    onClick: onClickProp as unknown as React.MouseEventHandler<ItemElement>,
    onFocus: onFocusProp as unknown as React.FocusEventHandler<ItemElement>,
    onKeyDown: onKeyDownProp as unknown as React.KeyboardEventHandler<ItemElement>,
    onMouseDown: onMouseDownProp as unknown as React.MouseEventHandler<ItemElement>,
  })
  ...
  const onClick = React.useCallback(
    ...
    [propsRef, onOpenChange, onSelect],
  )
  ...
  const onKeyDown = React.useCallback(
    ...
    [propsRef, focusContext, dir, orientation, loop],
  )
  ...
  const onMouseDown = React.useCallback(
    ...
    [propsRef, focusContext, itemId, disabled],
  )
