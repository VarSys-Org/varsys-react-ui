...
function PreviewCardTrigger(props: React.ComponentPropsWithoutRef<typeof PreviewCardPrimitive.Trigger>) {
  return (
...
function PreviewCardContent({
  ...
  return (
    <PreviewCardPrimitive.Portal>
      <PreviewCardPrimitive.Positioner className="isolate z-50">
