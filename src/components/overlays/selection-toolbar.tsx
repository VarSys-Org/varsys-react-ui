...
function SelectionToolbarItem(props: SelectionToolbarItemProps) {
  ...
  const propsRef = useAsRef({
    ...
    onPointerDown: onPointerDownProp as unknown as React.PointerEventHandler<ItemElement>,
    onPointerUp: onPointerUpProp as unknown as React.PointerEventHandler<ItemElement>,
  })
